...
A .vocab[statistical analysis plan] is a tool often used in clinical trials that
...
Importantly, SAPs are written *prior* to initiating of the clinical trial in
question. 
...
> We will use t-tests and chi-square tests to assess continuous and categorical variables, respectively.
...
- [TREND](https://www.cdc.gov/trendstatement/): Transparent Reporting of Evaluations wiht Nonrandomized Designs
...
.question[
Under this understanding, what are some other potential consequences? What is
a simple way we can mitigate some of these consequences?
]
