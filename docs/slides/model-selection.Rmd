...
Is there a relationship between buprenorphine-naloxone and time-to-relapse 
(while controlling for clinical, behavioral, and demographic factors)?

Given a patient's characteristics (including whether they receive BUP-NX), can
we predict their time-to-relapse? Can we come up with a model that does the best
job of doing so?
