---
title: "Writing statistical models"
author: "Yue Jiang"
...
```{r, out.width = "80%", eval=TRUE, echo=FALSE, warning = F, message = F}
include_graphics("img/addgithub1.png") 
```
...
```{r, out.width = "80%", eval=TRUE, echo=FALSE, warning = F, message = F}
include_graphics("img/addgithub2.png") 
```
...
```{r, out.width = "80%", eval=TRUE, echo=FALSE, warning = F, message = F}
include_graphics("img/addgithub3.png") 
```
...
include_graphics("img/addgithub4.png") 
```
...
```{r, out.width = "60%", eval=TRUE, echo=FALSE, warning = F, message = F}
include_graphics("img/addgithub5.png")
```
...
sqf <- read.csv("../datasets/sqf/case_03_dat.csv")
sqf <- sqf %>% 
  filter(weapon_found != "(",
         suspect_age != "(null)") %>% 
...
.question[
What about a Bayesian alternative to this OLS model? How would you formulate it?
What about priors on the parameters?
]
